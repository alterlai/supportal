...
{
    public function generateFileNameFromEntities(Building $building, Discipline $discipline, DocumentType $documentType, int $revision, string $fileExtension, ?string $floor = "")
    {
